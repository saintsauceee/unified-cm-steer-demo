...
interface Props { src: string | null; alt: string; isBaseline: boolean; onOpen: (src: string) => void; badge?: 'D' | 'N' | 'T' | null }
...
export function ImageCell({ src, alt, isBaseline, onOpen, badge }: Props) {
